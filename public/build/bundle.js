...
var app = (function () {
    ...
    /* src\Question.svelte generated by Svelte v3.46.1 */
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h5 = element("h5");
    			if_block.c();
    			add_location(h5, file$2, 42, 0, 850);
    		},
    ...
    // (51:0) {#each allAnswers as answer}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 51, 4, 994);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(51:0) {#each allAnswers as answer}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 57, 4, 1163);
    			add_location(div, file$2, 56, 0, 1151);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$2, 38, 0, 788);
    		},
    ...
    /* src\Quiz.svelte generated by Svelte v3.46.1 */
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*addToScore, nextQuestion, quiz, activeQuestion*/ 101) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "fade-wrapper svelte-r9nhk1");
    			add_location(div, file$1, 59, 8, 1163);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				div_intro = create_in_transition(div, fly, { y: 100, x: 100 });
    				div_intro.start();
    			});
    		...
    		o: function outro(local) {
    			...
    			div_outro = create_out_transition(div, fly, { y: 100, x: 100 });
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(59:4) {#if index === activeQuestion}",
    		ctx
    	});
    ...
    // (57:4) {#each data.results as question, index}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:4) {#each data.results as question, index}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(52:17)           Loading...      {:then data}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			info.block.c();
    			add_location(button, file$1, 46, 4, 822);
    			add_location(h3, file$1, 48, 4, 883);
    			add_location(h4, file$1, 49, 4, 915);
    			add_location(div, file$1, 45, 0, 810);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "WonderFilled Music!";
    			t1 = space();
    			create_component(quiz.$$.fragment);
    			add_location(h1, file, 5, 1, 62);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
